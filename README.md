...
<h1 align="center">
  Gatsby's hello-world starter with Tailwind and React Burger
</h1>
...
1.  **Create a Gatsby site.**
    ...
    gatsby new my-hello-world-starter https://github.com/thewebsiteguy/gatsby-tailwind-starter-hello-world
    ```
